...
int main() {
    cout << "Testing sentence splitter... "
         << ((test_sentenceSplitter()) ? "Success!!!" : "Failed...") << endl;
    cout << "Testing word pair mapping... "
         << ((test_wordpairMapping()) ? "Success!!!" : "Failed...") << endl;
    cout << "Testing frequency word pair map... "
         << ((test_freqWordpairMmap()) ? "Success!!!" : "Failed...") << endl;
    cout << "Testing print word pairs... "
         << ((test_printWordpairs()) ? "Success!!!" : "Failed...") << endl;
    return 0;
}